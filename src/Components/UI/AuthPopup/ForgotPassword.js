...
export default function ForgotPassword() {
    ...
    return (
    <>
        <Button onClick={handleClickOpen} variant='string' sx={{color: fontColor, textTransform: 'none', '&:hover': {backgroundColor: 'rgba(50,50,50,0.3)',boxShadow: '0 0 10px rgba(50, 50,50, 0.4)'}}} >
            forgot password
        </Button> 
        <Dialog
            open={openDialog}
            ...
            >
            <DialogTitle id="alert-dialog-title">{"Get new password"}</DialogTitle>
            <DialogContent>
